...
export const LOCALES = {
  en: {
    ...
    "focus.pause": "Pause",
    "focus.resume": "Resume",
    "focus.stop": "Stop the interval",
    "focus.done": "Complete the task",
    "focus.park": "Set aside (waiting)",
    "focus.remove": "Remove from the bar",
    "focus.fromSchedule": "Current slot from your schedule",
    "focus.untilSlotEnd": "until {time}",
    "focus.untilSlotEndHint": "Work until the end of the current schedule slot",
    "focus.waitingFor": "waiting for {min} min",
    "focus.minShort": "m",
    "focus.hourShort": "h",
    "focus.todayCount": "Pomodoros completed today",
    "focus.next": "next",
    "focus.hideBar": "Hide the focus bar",
    "focus.toggleBar": "Focus bar",
    "focus.workDone": "Pomodoro finished — time for a break",
    "focus.breakDone": "Break is over",
    "focus.doneToast": "Task completed",
    "focus.focusedToast": "Task is in focus",
    "settings.tab.focus": "Focus Bar",
    "settings.focus.title": "Focus Bar",
    "settings.focus.desc": "A slim bar docked to the top of the screen: the current task, a pomodoro timer, and parallel waiting tasks are always in sight.",
    "settings.focus.enabled": "Show the focus bar",
    "settings.focus.mode": "Docking",
    "settings.focus.modeDesc": "AppBar reserves screen space like the taskbar (Windows). Overlay floats above other windows without reserving space.",
    "settings.focus.mode.appbar": "AppBar",
    "settings.focus.mode.overlay": "Overlay",
    "settings.focus.size": "Bar height",
    "settings.focus.size.auto": "Auto (1/40 of screen)",
    "settings.focus.size.compact": "Compact",
    "settings.focus.modules": "Bar contents",
    "settings.focus.modulesDesc": "Less is more: keep only what helps you stay on the current task.",
    "settings.focus.module.timer": "Pomodoro countdown",
    "settings.focus.module.presets": "Interval buttons and “until slot end”",
    "settings.focus.module.controls": "Pause / Done / Set aside buttons",
    "settings.focus.module.waiting": "Waiting tasks (chips)",
    "settings.focus.module.counter": "Pomodoro counter for today",
    "settings.focus.module.nextSlot": "Next schedule slot",
    "settings.focus.module.clock": "Clock",
    "settings.focus.pomodoro": "Pomodoro intervals",
    "settings.focus.pomodoroDesc": "Buttons on the bar. A break starts automatically after each interval (0 — no break).",
    "settings.focus.pomodoro.presets": "Buttons (minutes, comma-separated)",
    "settings.focus.pomodoro.breakMin": "Break",
    // flow
    ...
    "settings.maintenance.cleanupLookups.label": "Clean up unused lists, tags, personas, flows",
    "settings.maintenance.cleanupLookups.desc": "Removes entries no longer referenced by any task. Flows with saved description/color/deadline are kept.",
    "settings.maintenance.cleanupLookups.btn": "Clean up",
    "settings.maintenance.cleanupLookups.running": "Cleaning…",
    "settings.maintenance.cleanupLookups.done": "Removed {n} unused entries",
    "settings.maintenance.cleanupLookups.nothing": "Nothing to clean up",
    "settings.maintenance.diagnostics.label": "Diagnostics",
    "settings.maintenance.diagnostics.desc": "Per-session fetchAll timings and current task count. Use to decide if incremental updates are worth the complexity.",
    "settings.maintenance.diagnostics.empty": "No measurements yet — refresh the list once.",
    ...
    "planner.planned": "Scheduled in planner",
  ...
  ru: {
    ...
    "ctx.focus": "В фокус",
    // focus bar
    "focus.pickTask": "Выберите задачу…",
    "focus.break": "Перерыв",
    "focus.skipBreak": "Пропустить перерыв",
    "focus.pause": "Пауза",
    "focus.resume": "Продолжить",
    "focus.stop": "Остановить интервал",
    "focus.done": "Завершить задачу",
    "focus.park": "Отложить (ожидает)",
    "focus.remove": "Убрать с панели",
    "focus.fromSchedule": "Текущий слот расписания",
    "focus.untilSlotEnd": "до {time}",
    "focus.untilSlotEndHint": "Работать до конца текущего слота расписания",
    "focus.waitingFor": "ожидает {min} мин",
    "focus.minShort": "м",
    "focus.hourShort": "ч",
    "focus.todayCount": "Помидоров за сегодня",
    "focus.next": "далее",
    "focus.hideBar": "Скрыть панель фокуса",
    "focus.toggleBar": "Панель фокуса",
    "focus.workDone": "Помидор завершён — пора на перерыв",
    "focus.breakDone": "Перерыв окончен",
    "focus.doneToast": "Задача выполнена",
    "focus.focusedToast": "Задача в фокусе",
    "settings.tab.focus": "Панель фокуса",
    "settings.focus.title": "Панель фокуса",
    "settings.focus.desc": "Узкая панель, пристыкованная к верху экрана: текущая задача, таймер помидора и параллельные ожидающие задачи всегда на виду.",
    "settings.focus.enabled": "Показывать панель фокуса",
    "settings.focus.mode": "Стыковка",
    "settings.focus.modeDesc": "AppBar резервирует место на экране, как панель задач (Windows). Оверлей висит поверх окон, не резервируя место.",
    "settings.focus.mode.appbar": "AppBar",
    "settings.focus.mode.overlay": "Оверлей",
    "settings.focus.size": "Высота панели",
    "settings.focus.size.auto": "Авто (1/40 экрана)",
    "settings.focus.size.compact": "Компактная",
    "settings.focus.modules": "Состав панели",
    "settings.focus.modulesDesc": "Меньше — лучше: оставьте только то, что помогает держаться текущей задачи.",
    "settings.focus.module.timer": "Обратный отсчёт помидора",
    "settings.focus.module.presets": "Кнопки интервалов и «до конца слота»",
    "settings.focus.module.controls": "Кнопки «Пауза» / «Готово» / «Отложить»",
    "settings.focus.module.waiting": "Ожидающие задачи (чипы)",
    "settings.focus.module.counter": "Счётчик помидоров за день",
    "settings.focus.module.nextSlot": "Следующий слот расписания",
    "settings.focus.module.clock": "Часы",
    "settings.focus.pomodoro": "Интервалы помидора",
    "settings.focus.pomodoroDesc": "Кнопки на панели. Перерыв запускается автоматически после интервала (0 — без перерыва).",
    "settings.focus.pomodoro.presets": "Кнопки (минуты, через запятую)",
    "settings.focus.pomodoro.breakMin": "Перерыв",
    // flow
    ...
    "settings.maintenance.cleanupLookups.label": "Очистить неиспользуемые списки, теги, персонажи, потоки",
    "settings.maintenance.cleanupLookups.desc": "Удаляет записи, на которые больше не ссылается ни одна задача. Потоки с сохранёнными описанием/цветом/дедлайном остаются.",
    "settings.maintenance.cleanupLookups.btn": "Очистить",
    "settings.maintenance.cleanupLookups.running": "Чистим…",
    "settings.maintenance.cleanupLookups.done": "Удалено ненужных записей: {n}",
    "settings.maintenance.cleanupLookups.nothing": "Очищать нечего",
    "settings.maintenance.diagnostics.label": "Диагностика",
    "settings.maintenance.diagnostics.desc": "Тайминги fetchAll за сессию и текущее число задач. Нужны, чтобы решить, стоит ли incremental-обновление сложной реализации.",
    "settings.maintenance.diagnostics.empty": "Замеров пока нет — обнови список хотя бы раз.",

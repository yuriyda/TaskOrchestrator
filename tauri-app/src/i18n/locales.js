...
export const LOCALES = {
  en: {
    ...
    "sync.imported": "Applied: {applied}, skipped: {skipped}, conflicts: {conflicts}",
    ...
    "sync.apply": "Apply",
    "sync.appliedWithResponse": "Applied: {applied}, conflicts: {conflicts}. Response copied ({responseCount} tasks for sender).",
    "sync.appliedNoResponse": "Applied: {applied}, conflicts: {conflicts}. No response needed (sender is up to date).",
    "sync.pasteBtn": "Paste",
    ...
    "sync.gdriveSynced": "Synced: applied {applied}, conflicts {conflicts}, uploaded {uploaded} tasks",
  ...
  ru: {
    ...
    "sync.imported": "Применено: {applied}, пропущено: {skipped}, конфликтов: {conflicts}",
    ...
    "sync.appliedWithResponse": "Применено: {applied}, конфликтов: {conflicts}. Ответ скопирован ({responseCount} задач для отправителя).",
    "sync.appliedNoResponse": "Применено: {applied}, конфликтов: {conflicts}. Ответ не нужен (отправитель актуален).",
    ...
    "sync.gdriveSynced": "Синхронизировано: применено {applied}, конфликтов {conflicts}, отправлено {uploaded} задач",

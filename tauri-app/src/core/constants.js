...
export const STATUSES    = ["inbox", "active", "done", "cancelled"];
export const STATUS_ICONS = { inbox: Inbox, active: Zap, done: Check, cancelled: X };
export const PRIORITY_COLORS = { 1: "#ef4444", 2: "#fb923c", 3: "#60a5fa", 4: "#6b7280" };
export const STATUS_ORDER    = { inbox: 0, active: 1, done: 2, cancelled: 3 };
export const SORT_FIELDS     = ["priority", "status", "due", "createdAt"];
...
export const VALID_STATUSES = ['inbox', 'active', 'done', 'cancelled'];
export const VALID_PRIORITIES = [1, 2, 3, 4];

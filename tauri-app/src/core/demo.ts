...
export function buildDemoTasks() {
  ...
  const tasks = [
    // ── Work ────────────────────────────────────────────────────────────────
    t(1,  'Prepare Q2 roadmap presentation',    'Work', 'active',    1, rel(3),  { estimate: '3 hours',   tags: ['meeting','planning'],   personas: ['Alice'],           flowId: 'ProductLaunch', dateStart: rel(0), rtmSeriesId: id(1), notes: [{ id: ulid(), content: 'Include: user growth, revenue trends, Q3 goals, technical roadmap, hiring plan', createdAt: now() }] }),
    ...
    t(5,  'Write API documentation',            'Work', 'active',    2, rel(5),  { estimate: '4 hours',   tags: ['code','planning'],                                      rtmSeriesId: id(5), notes: [{ id: ulid(), content: 'Auth, Users, Tasks, Reports, Webhooks', createdAt: now() }], url: 'https://swagger.io/docs/specification/' }),
    ...
    t(10, 'Conduct 5 user research interviews', 'Work', 'inbox',     2, rel(10), { estimate: '5 hours',   tags: ['research','meeting'],    personas: ['Diana'],           flowId: 'ProductLaunch', dependsOn: [id(6)], dateStart: rel(3), rtmSeriesId: id(10), notes: [{ id: ulid(), content: 'Q1: Walk me through your typical day\nQ2: What are the biggest pain points?\nQ3: How do you currently solve this?', createdAt: now() }] }),
    ...
    t(20, 'Meal prep for the week',             'Health',   'active', 3, rel(2),  { estimate: '2 hours', tags: ['fitness'],               flowId: 'WeeklyWellness',        recurrence: 'weekly', rtmSeriesId: id(20), notes: [{ id: ulid(), content: 'Mon: chicken & rice\nTue: pasta primavera\nWed: salad bowl\nThu: stir fry\nFri: leftovers', createdAt: now() }] }),
    ...
    t(28, 'Write blog post: React perf tips',   'Learning', 'active', 2, rel(12), { estimate: '3 hours',  tags: ['code','planning'],      dateStart: rel(5),               rtmSeriesId: id(28), notes: [{ id: ulid(), content: '1. useMemo and useCallback\n2. Code splitting\n3. Virtual lists\n4. Image optimization\n5. Bundle analysis', createdAt: now() }] }),
    ...
    t(31, 'File quarterly taxes',               'Finance',  'inbox',  1, rel(21), { estimate: '3 hours',  tags: ['urgent','budget'],      dateStart: rel(14),              rtmSeriesId: id(31), notes: [{ id: ulid(), content: '☐ W-2 / 1099 forms\n☐ Last year\'s return\n☐ Mortgage interest statement\n☐ Charitable donation receipts\n☐ Medical expense records', createdAt: now() }] }),
    ...
    // ── Cancelled ─────────────────────────────────────────────────────────────
    t(49, 'Migrate monolith to microservices',  'Work',     'cancelled', 2, rel(-30), { estimate: '40 hours', tags: ['code','planning'], personas: ['Bob','Charlie'], rtmSeriesId: id(49), notes: [{ id: ulid(), content: 'Scope too large for current team. Will revisit in Q4 with dedicated resources.', createdAt: now() }] }),
